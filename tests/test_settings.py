...
def test_settings_blank_cover_letter_filename_pattern_falls_back_to_default(temp_db_path, monkeypatch):
    import services.settings as settings_module
    ...
    settings_module.save_settings({"cover_letter_filename_pattern": ""})
    loaded = settings_module.load_settings()

    assert loaded["cover_letter_filename_pattern"] == settings_module.get_default_cover_letter_filename_pattern()
...
def test_initialize_settings_state_uses_default_filename_pattern_when_saved_value_is_blank(
    temp_db_path, monkeypatch
):
    import services.settings as settings_module
    import views.settings as settings_view
